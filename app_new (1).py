...
with st.sidebar:
    ...
    st.markdown("""
    <div style="font-size:0.82rem; color:#d1fae5; line-height:1.6;">
    <strong style="color:white;">Trashkara</strong> adalah platform
    <em>Intelligent Waste Classifier & Generative Upcycling Assistant</em>
    yang dikembangkan oleh tim <strong style="color:white;">CC26-PSU013</strong>
    dalam program Data Science 2026.<br><br>
    Dashboard ini mendukung pengambilan keputusan berbasis data untuk
    <strong style="color:white;">pengelolaan sampah yang lebih efisien dan berkelanjutan</strong>.
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="font-size:0.82rem; color:#d1fae5; line-height:1.8;">
    🌿 <strong style="color:white;">BQ1 — Emisi CO₂e</strong><br>
    <span style="font-size:0.78rem;">Kategori mana yang menyumbang emisi tertinggi & korelasi dengan kesulitan daur ulang?</span><br><br>
    💰 <strong style="color:white;">BQ2 — Struktur Biaya</strong><br>
    <span style="font-size:0.78rem;">Distribusi beban biaya lintas kategori & kuadran high-cost burden?</span><br><br>
    🧪 <strong style="color:white;">A/B Testing</strong><br>
    <span style="font-size:0.78rem;">Apakah metode pengumpulan terstruktur menghasilkan beban biaya lebih rendah?</span>
    </div>
    """, unsafe_allow_html=True)
